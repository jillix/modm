...
exports.string = function (data) {
    return data.constructor.name === "String" ? true : false;
};
exports.number = function (data) {
     return data.constructor.name === "Number" ? true : false;
};
exports.array = function (data) {
    return data.constructor.name === 'Array' ? true : false;
};
exports.object = function (data) {
    return data.constructor.name === 'Object' ? true : false;
};
exports.boolean = function (data) {
    return data.constructor.name === "Boolean" ? true : false;
};
exports.buffer = function (data) {
    return data.constructor.name === "Buffer" ? true : false;
};
exports.objectid = function (data) {
    return data.constructor.name === "ObjectID" ? true : false;
};
