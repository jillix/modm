...
function adapter (method, args, docIndex) {
    ...
    if (!this.db.connection) {
        ...
        return this.db.connect((function (self, caller, method, args, docIndex) {
            
            return function (err, db) {
                
                return caller.call(self, method, args, docIndex);
            }
        })(this, adapter.caller, method, args, docIndex));
    }
    ...
    if (typeof this.collection === 'string') {
        this.collection = this.db.connection.collection(self.collection);
    }
